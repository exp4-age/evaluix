...
from PyQt6.QtCore import Qt, QCoreApplication, QUrl, QItemSelection
...
# Example Data
# Example normal LMOKE data
read_file(
    data,
    str(own_path / "ExampleData/2024_0177_1_LMOKE_2024-08-09_13-53-45.txt"),
    dataformat="MOKE",
)
# Example Kerr Hys data
read_file(
    data,
    str(own_path / "ExampleData/2023_0424_10µm/hys.txt"),
    dataformat="Kerr",
)
...
# read_file(
#     data,
#     str(own_path / "ExampleData/2023_0424_10µm"),
#     dataformat="Kerr_imgs",
# )
...
class MainWindow(QMainWindow):
    ...
    def initialize_hys_tab(self):
        ...
        self.hys_macro_widget.editButtonClicked.connect(ProfileMacrosDialog(self, macros).exec_)
